...
export const loadGalerias =
  'https://litoral-df396-default-rtdb.firebaseio.com/galeria.json';
export const loadSolicitudes =
  'https://litoral-df396-default-rtdb.firebaseio.com/solicitudes.json';
