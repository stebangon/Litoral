  ...
  return (
    <div className="App">
      ...
      <div id="cuerpo">
        <Container>
          <Row>
            <Col id="imagenesPortada" className="md-8">
              <Row className="pl-3 justify-content-center">
                <img height="450px" src={renderImagenPortada()} />
              </Row>
              <Row
                id="lineaSolLuna"
                className={
              ...
              >
                <Col className="md-8">
                  <img
                    ...
                    src={imgSol}
                  />
                  <span className="px-5">PLANTA BAJA</span>
                  <img
                    className="mx-3"
                    style={{ margin: 0, textAlign: 'end' }}
                    width="12px"
              ...
              >
                <Col className="md-8">
                  <img
                    ...
                    src={imgSol}
                  />
                  <span className="px-5">PLANTA ALTA</span>
                  <img
                    className="mx-3"
                    style={{ margin: 0, textAlign: 'end' }}
                    width="12px"
            ...
            <Col id="botones" className="md-4">
              ...
              <Row className="pr-5 pt-5 justify-content-end">
          ...
          <Row>
            <Col id="caracteristicas" className="md-9">
              <Row>
                <Col className="md-6">
            ...
            <Col id="dimensiones" className="md-3">
              <Row className="pl-5 justify-content-center">
                <Col
                  className="md-6"
                  style={{
                    maxWidth: '200px',
        ...
        <div id="imagenes" className="pt-5">
          ...
          <Row>
            <Col>
              <Jumbotron className={renderImagenes()[0]} fluid></Jumbotron>
            </Col>
          </Row>
          <br />
          <Row>
